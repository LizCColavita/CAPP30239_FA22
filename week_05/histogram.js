...
d3.json('climate-jan.json').then((data) => {
  ...
  const bins = d3.bin()
    .thresholds(10) //number of  bins you want across the page
  ...
  g.append("rect") //appending rectangles for each bin of the histogram
  ...
  g.append("text")
    ...
    .transition()
    .duration(750)
    .attr("y", d => y(d.length) - 5); //no height, only bars have height
